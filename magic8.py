# Name : Caleb Kimble
# Prog Purpose: This Magic 8-Ball code uses a Pythoon tuple since the user does not have the ability to change the 8- ball answers
# Could have used python list instead of tuple
# Tuples ues parenthese; lists use square braces
