...
def open_out_file():        
    ...
    f.write('<body style="background-color: #985b45; background-image: url(beach.jpg);background-size: cover;background-repeat: no-repeat;color: #111111;">\n')
...
def create_output_html():
    ...
    f.write("<table border = 3; style = 'background-color: #f2eaa5; margin: auto;'>")
